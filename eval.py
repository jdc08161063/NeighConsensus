...
from eval_plot import plotCorres


def evalPascal(model, testTransform, df, featExtractor, imgDir, maxSize, sigma, nbWeightPoint, alpha = 0.1, saveDir = None) : 
...
if __name__ == '__main__' : 
    ...
    ## Parameters
    parser = argparse.ArgumentParser(description='Nc-Net Evaluation')
    ...
    pckRes = evalPascal(model, testTransform, df, args.featExtractor, args.imgDir, args.maxSize, args.sigma, args.nbWeightPoint, args.alpha, args.saveDir)
